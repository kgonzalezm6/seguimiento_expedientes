        ...
        <modal :open="expedienteStore.open_aceptar" title="Aceptar expediente"
            icon="clipboard-check" @close="expedienteStore.open_aceptar = !expedienteStore.open_aceptar" class="w-5/6">
                    <div class="flex items-center">
                        ...
                        <span class="text-3xl ml-6 font-semibold">¿Esta seguro de aceptar el expediente # {{expedienteStore.isWorkFlow ? expedienteStore.one_expediente.num_expediente : expedienteStore.one_expediente.num_iusicaso}} ?</span>
                    </div>
